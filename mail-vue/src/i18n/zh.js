const zh = {
    ...
    addUser: '添加用户',
    batchAddUser: '批量添加',
    batchAddRoleName: '权限名称',
    batchAddUserDesc: '使用竖线分隔提交，多个使用换行分开，每次最多100个，格式如下：',
    batchGenerateCount: '生成个数',
    batchGenerateRemark: '批量备注',
    batchGenerateDomain: '选择邮箱域名',
    batchGenerateRole: '权限身份',
    batchGenerateSubmit: '提交批量',
    batchGenerateCountError: '生成个数必须是大于0的整数',
    batchGenerateDomainError: '请选择邮箱域名',
    batchGenerateRoleError: '请选择权限身份',
    batchAddCurrentCount: '当前共 {count} 条',
    batchAddResult: '批量添加结果',
    batchAddSubmittedCount: '提交个数',
    batchAddSuccessCount: '成功个数',
    batchAddFailCount: '失败个数',
    batchAddFailedDetails: '失败详情',
    batchAddFailureItem: '第{line}行 {email}：{reason}',
    batchAddEmptyMsg: '批量添加内容不能为空',
    batchAddMaxCountMsg: '每次最多批量添加100个用户',
    batchAddLineFormatError: '第{line}行格式错误',
    batchAddLineEmailError: '第{line}行邮箱格式不正确',
    batchAddLineDomainError: '第{line}行邮箱域名不在系统允许范围内',
    batchAddLinePwdError: '第{line}行密码至少六位',
    batchAddLineRoleError: '第{line}行权限名称不存在',
    addSubAdmin: '添加子管理员',
    selectUser: '选择用户',
    mainAdmin: '主管理员',
    subAdmin: '子管理员',
    ...
    sendEmail: '邮件发送',
    attachmentLimitSetting: '附件限制',
    attachmentLimitConfig: '附件限制设置',
    attachmentSizeLimitMb: '附件大小限制',
    contentImageSizeLimitMb: '正文图片大小限制',
    zeroMeansUnlimited: '填 0 表示不限制，留空表示未设置',
    apiSetting: '接口设置',
    publicApi: '公共接口',
    apiKeyConfig: 'API Key 设置',
    appKeyHeaderDesc: '公共接口请求头需传入 c-app-key',
    ...
    backupData: '备份数据',
    backupSystemDatabase: '备份系统数据库',
    backupTime: '备份时间',
    backupTimeDesc: '按固定周期执行备份',
    backupStorageConfig: '备份对象存储配置',
    backupRetentionDesc: '仅保留最新5份数据',
    backupIntervalDays: '每几天',
    backupHour: '小时',
    everyDaysAtHour: '每 {days} 天的 {hour} 点',
    manualBackup: '手动备份',
    manualBackupConfirm: '确认立即执行一次数据库备份吗？',
    backupStatus: '备份状态',
    backupStage: '当前阶段',
    backupMessage: '状态信息',
    backupDetails: '详细信息',
    backupQueued: '已加入备份队列',
    backupValidating: '校验备份配置',
    backupExporting: '导出数据库内容',
    backupUploading: '上传备份文件',
    backupCleaning: '清理旧备份',
    backupCompleted: '备份完成',
    backupFailed: '备份失败',
    backupPollingTimeout: '备份状态轮询超时，请稍后手动刷新查看',
    backupAlreadyRunning: '已有备份任务正在执行',
    about: '关于',
    version: '版本',
    community: '交流',
    changeTitle: '修改标题',
    ...
    saveSuccessMsg: '保存成功',
    attachmentLimitNotConfigMsg: '请先设置正文图片与附件大小限制，填0表示不限制',
    attachmentSizeLimitExceededMsg: '附件 {msg} 超过 {limit} MB 限制',
    contentImageSizeLimitExceededMsg: '正文图片超过 {limit} MB 限制',
    ...
    storageType: '存储类型',
    backupBucket: '备份 Bucket',
    backupEndpoint: '备份 Endpoint',
    backupRegion: '备份 Region',
    backupAccessKey: '备份 Access Key',
    backupSecretKey: '备份 Secret Key',
