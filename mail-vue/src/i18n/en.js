const en = {
    ...
    admin: 'Admin',
    addUser: 'Add User',
    batchAddUser: 'Batch Add',
    batchAddRoleName: 'Role Name',
    batchAddUserDesc: 'Separate fields with vertical bars and records with new lines. Up to 100 users each time. Format:',
    batchGenerateCount: 'Generate Count',
    batchGenerateRemark: 'Batch Remark',
    batchGenerateDomain: 'Select Email Domain',
    batchGenerateRole: 'Role',
    batchGenerateSubmit: 'Append Batch',
    batchGenerateCountError: 'Generate count must be an integer greater than 0',
    batchGenerateDomainError: 'Please select an email domain',
    batchGenerateRoleError: 'Please select a role',
    batchAddCurrentCount: 'Current total: {count}',
    batchAddResult: 'Batch Add Result',
    batchAddSubmittedCount: 'Submitted',
    batchAddSuccessCount: 'Succeeded',
    batchAddFailCount: 'Failed',
    batchAddFailedDetails: 'Failure Details',
    batchAddFailureItem: 'Line {line} {email}: {reason}',
    batchAddEmptyMsg: 'Batch add content cannot be empty',
    batchAddMaxCountMsg: 'You can batch add up to 100 users at a time',
    batchAddLineFormatError: 'Line {line} has an invalid format',
    batchAddLineEmailError: 'Line {line} has an invalid email address',
    batchAddLineDomainError: 'Line {line} uses a domain that is not allowed by this system',
    batchAddLinePwdError: 'Line {line} password must be at least 6 characters',
    batchAddLineRoleError: 'Line {line} role name does not exist',
    ...
    attachmentLimitSetting: 'Attachment Limits',
    attachmentLimitConfig: 'Attachment Limit Settings',
    attachmentSizeLimitMb: 'Attachment Size Limit',
    contentImageSizeLimitMb: 'Content Image Size Limit',
    zeroMeansUnlimited: 'Use 0 for unlimited, leave empty for not configured',
    apiSetting: 'API Settings',
    publicApi: 'Public API',
    apiKeyConfig: 'API Key Settings',
    appKeyHeaderDesc: 'Public API requests must include the c-app-key header',
    ...
    backupSystemDatabase: 'Backup System Database',
    backupTime: 'Backup Schedule',
    backupTimeDesc: 'Run backups on a fixed schedule to reduce cron invocations',
    backupStorageConfig: 'Backup Storage',
    backupRetentionDesc: 'Only keep the latest 5 backups',
    backupIntervalDays: 'Every N Days',
    backupHour: 'Hour',
    everyDaysAtHour: 'Every {days} day(s) at {hour}:00',
    manualBackup: 'Run Backup',
    manualBackupConfirm: 'Do you want to run a database backup now?',
    backupStatus: 'Backup Status',
    backupStage: 'Stage',
    backupMessage: 'Message',
    backupDetails: 'Details',
    backupQueued: 'Backup queued',
    backupValidating: 'Validating backup configuration',
    backupExporting: 'Exporting database content',
    backupUploading: 'Uploading backup file',
    backupCleaning: 'Cleaning old backups',
    backupCompleted: 'Backup completed',
    backupFailed: 'Backup failed',
    backupPollingTimeout: 'Backup status polling timed out. Please check again later.',
    backupAlreadyRunning: 'A backup task is already running',
    about: 'About',
    version: 'Version',
    community: 'Community',
    ...
    attachmentLimitNotConfigMsg: 'Please configure image and attachment size limits first. Use 0 for unlimited.',
    attachmentSizeLimitExceededMsg: 'Attachment {msg} exceeds the {limit} MB limit',
    contentImageSizeLimitExceededMsg: 'Content image exceeds the {limit} MB limit',
    ...
    backupAccessKey: 'Backup Access Key',
