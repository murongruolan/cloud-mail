const zh = {
	...
	turnstileKeyNotConfig: '请先填写并保存 Site Key 与 Secret Key',
	backupIntervalInvalid: '备份间隔天数无效',
	backupHourInvalid: '备份小时无效',
	backupStorageNotConfig: '请先完善备份对象存储配置',
	attachmentLimitNotConfig: '请先设置正文图片与附件大小限制，填0表示不限制',
	attachmentSizeLimitExceeded: '附件大小超过{{msg}}MB限制',
	contentImageSizeLimitExceeded: '正文图片大小超过{{msg}}MB限制',
	subAdminDisabled: '子管理员已被禁用',
	subAdminUserNotExist: '要设置为子管理员的用户不存在',
	subAdminAlreadyExist: '该用户已经是子管理员',
	subAdminCannotBeMainAdmin: '主管理员不能被设置为子管理员',
	subAdminNotExist: '子管理员不存在',
	batchAddEmptyContent: '批量添加内容不能为空',
	batchAddTooMany: '每次最多批量添加100个用户',
	batchAddLineFormatInvalid: '第{{line}}行格式错误',
	batchDuplicateEmail: '批量内容中存在重复邮箱',
