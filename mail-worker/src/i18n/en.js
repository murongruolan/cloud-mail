const en = {
	...
	turnstileKeyNotConfig: 'Please save the Site Key and Secret Key first',
	backupIntervalInvalid: 'Invalid backup interval days',
	backupHourInvalid: 'Invalid backup hour',
	backupStorageNotConfig: 'Please complete the backup storage configuration first',
	attachmentLimitNotConfig: 'Please configure image and attachment size limits first. Use 0 for unlimited.',
	attachmentSizeLimitExceeded: 'Attachment size exceeds the {{msg}}MB limit',
	contentImageSizeLimitExceeded: 'Content image size exceeds the {{msg}}MB limit',
	subAdminDisabled: 'Sub-admin has been disabled',
	subAdminUserNotExist: 'The selected user does not exist',
	subAdminAlreadyExist: 'This user is already a sub-admin',
	subAdminCannotBeMainAdmin: 'The main admin cannot be added as a sub-admin',
	subAdminNotExist: 'Sub-admin does not exist',
	batchAddEmptyContent: 'Batch add content cannot be empty',
	batchAddTooMany: 'You can batch add up to 100 users at a time',
	batchAddLineFormatInvalid: 'Line {{line}} has an invalid format',
	batchDuplicateEmail: 'The batch content contains duplicate email addresses',
